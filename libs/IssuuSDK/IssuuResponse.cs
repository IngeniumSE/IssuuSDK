...
/// <summary>
/// Represents a Issuu response with payload data.
/// </summary>
/// <param name="method">The HTTP method requested.</param>
/// <param name="uri">The URI requested.</param>
/// <param name="isSuccess">States whether the status code is a success HTTP status code.</param>
...
/// <summary>
/// Represents a Issuu error response.
/// </summary>
...
/// <summary>
/// Represents metadata for a Issuu request.
/// </summary>
public class Meta
{
	/// <summary>
...
/// <summary>
/// Represents rate-limiting information for a Issuu request.
/// </summary>
